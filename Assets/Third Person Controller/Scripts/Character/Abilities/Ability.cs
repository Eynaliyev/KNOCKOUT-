...
namespace Opsive.ThirdPersonController.Abilities
{
    ...
    public abstract class Ability : MonoBehaviour
    {
        ...
        public enum InputStartType { None, ButtonDown, DoublePress, Manual }
        // Specifies how the ability can be stopped from input. Button toggle means that the same button has to be pressed again after the ability has started to stop the ability
        public enum InputStopType { None, ButtonUp, ButtonToggle }
        ...
        [Tooltip("Specifies how the ability can be started from input")]
        [SerializeField] private InputStartType m_InputStartType;
        [Tooltip("Specifies how the ability can be stopped from input")]
        [SerializeField] private InputStopType m_InputStopType;
        ...
        [SerializeField] private Sprite m_Indicator;
        ...
        public string InputName
        {
            ...
            set
            {
                ...
                if (!string.IsNullOrEmpty(m_InputName)) {
                    GetComponent<ControllerHandler>().RegisterAbility(this, m_InputName);
                }
            }
        }
        public InputStartType StartType { get { return m_InputStartType; } set { m_InputStartType = value; } }
        public InputStopType StopType { get { return m_InputStopType; } set { m_InputStopType = value; } }
        ...
        public virtual bool IsConcurrentAblity() { return false; }
        ...
        public void StartAbility()
        {
            ...
            if (CanHaveItemEquipped() || m_ItemEquipped.Get() == false) {
                AbilityStarted();
            } else {
                m_EquipItem = true;
        ...
        public virtual bool Move(ref float horizontalMovement, ref float forwardMovement, Quaternion lookRotation) { return false; }
        ...
        /// </summary>
        public virtual bool CheckForExternalForces(float xPercent, float zPercent) { return false; }
        ...
        public virtual bool CheckMovement() { return false; }
        ...
        public virtual bool AnimatorMove() { return false; }
        ...
        public virtual bool HasAnimatorControl(int layer) { return true; }
        ...
        /// <summary>
        /// Move to the target position/rotation at the move spped. The onComplete action will be called after the character has arrived.
        /// </summary>
        ...
        /// <summary>
        /// Local method to move to the target position/rotation at the move spped. The onComplete action will be called after the character has arrived.
        /// </summary>
        /// <param name="targetPosition">The target position.</param>
        /// <param name="targetRotation">The target rotation.</param>
        /// <param name="minMoveSpeed">The minimum speed to move positions.</param>
        ...
        private IEnumerator MoveToTargetLocal(Vector3 targetPosition, Quaternion targetRotation, float minMoveSpeed, Action onComplete)
        {
            ...
            m_Controller.StopMovement(false);
            // Set the controller to moving to allow the correct animations to be played.
            ...
            while (Mathf.Abs(m_Transform.position.x - targetPosition.x) > 0.1f || Mathf.Abs(m_Transform.position.z - targetPosition.z) > 0.1f || 
            ...
            m_AnimatorMonitor.SetForwardInputValue(0, 0);
