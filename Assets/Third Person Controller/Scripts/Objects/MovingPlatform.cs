...
namespace Opsive.ThirdPersonController
{
...
#endif
    {
        ...
        [SerializeField] private bool m_MoveWhenEnabled;
        [Tooltip("The amount of dampening to make the movement smooth")]
        [SerializeField] private float m_MoveDampening;
        ...
        [SerializeField] private bool m_StopAtWaypoint = false;
        [Tooltip("Can the direction be changed while the platform is moving?")]
        [SerializeField] private bool m_CanInteractWhileMoving = false;
        ...
        [SerializeField] private int m_StartWaypointIndex = 1;
