...
namespace Opsive.ThirdPersonController.Editor
{
    ...
    public class CharacterFootstepsInspector : InspectorBase
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(feetProperty.GetArrayElementAtIndex(0), new GUIContent("Left Foot"));
            EditorGUILayout.PropertyField(feetProperty.GetArrayElementAtIndex(1), new GUIContent("Right Foot"));
            ...
            if (EditorGUI.EndChangeCheck()) {
                ...
                EditorUtility.SetDirty(characterFootsteps);
            }
        }
    }
}