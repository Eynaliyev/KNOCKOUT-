...
namespace Opsive.ThirdPersonController
{
    ...
    public class SimpleTurret : MonoBehaviour
    {
        ...
        [SerializeField] private float m_FireRange = 20.0f;
        ...
        [SerializeField] private float m_TargetYDifference = 4;
        ...
        public void DoFire()
        {
            ...
            projectile.Initialize(-m_Transform.forward, Vector3.zero);
