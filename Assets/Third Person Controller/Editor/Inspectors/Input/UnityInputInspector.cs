...
namespace Opsive.ThirdPersonController.Editor.Input
{
    ...
    public class UnityInputInspector : InspectorBase
    {
        ...
        public static void UpdateInputManager()
        {
            ...
            AddInputAxis(axesProperty, "Fire1", "", "", "", "", 1000, 0.001f, 1000, false, false, AxisType.Joystick, AxisNumber.Three);
            AddInputAxis(axesProperty, "Fire2", "", "joystick button 8", "", "", 1000, 0.001f, 1000, false, false, AxisType.KeyMouseButton, AxisNumber.X);
            ...
            AddInputAxis(axesProperty, "Mouse Y", "", "", "", "", 0, 0.19f, 1, false, false, AxisType.Joystick, AxisNumber.Five);

            // New axis:
            AddInputAxis(axesProperty, "Sprint", "", "left shift", "", "", 1000, 0.001f, 1000, false, false, AxisType.KeyMouseButton, AxisNumber.X);
            ...
            AddInputAxis(axesProperty, "Secondary", "", "", "", "", 1000, 0.001f, 1000, false, false, AxisType.Joystick, AxisNumber.Three);
            ...
            AddInputAxis(axesProperty, "Right Joystick X", "", "", "", "", 0, 0.19f, 1, false, false, AxisType.Joystick, AxisNumber.Four);
            AddInputAxis(axesProperty, "Right Joystick Y", "", "", "", "", 0, 0.19f, 1, false, false, AxisType.Joystick, AxisNumber.Five);
            AddInputAxis(axesProperty, "Drop Dual Wield Item", "", "g", "", "", 1000, 0.001f, 1000, false, false, AxisType.KeyMouseButton, AxisNumber.X);
