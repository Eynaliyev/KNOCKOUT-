...
namespace Opsive.ThirdPersonController
{
    ...
    public class LaserSight : MonoBehaviour
    {
        ...
        [SerializeField] private float m_MaxLength = 1000;
        [Tooltip("The minimum width of the laser")]
        [SerializeField] private float m_MinWidth = 0.3f;
        [Tooltip("The maximum width of the laser")]
        [SerializeField] private float m_MaxWidth = 0.7f;
        [Tooltip("The speed at which the laser changes width")]
        [SerializeField] private float m_PulseSpeed = 0.5f;
