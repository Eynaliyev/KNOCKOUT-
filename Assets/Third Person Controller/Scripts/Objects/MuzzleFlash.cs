...
namespace Opsive.ThirdPersonController
{
    ...
    public class MuzzleFlash : MonoBehaviour
    {
        ...
        public void Show()
        {
            m_Color = m_Material.GetColor(TintColor);
