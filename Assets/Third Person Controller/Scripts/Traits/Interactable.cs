...
namespace Opsive.ThirdPersonController
{
    ...
    public class Interactable : MonoBehaviour, IInteractable
    {
        ...
        [SerializeField] private MonoBehaviour m_Target;
        ...
        [SerializeField] private float m_InteractorLookInteractMaxAngle = 30;
        [Tooltip("The character can interact when the angle between the camera direction and interactable object is less than this amount")]
        [SerializeField] private float m_CameraLookInteractMaxAngle = 15;
        [Tooltip("The maximum x offset that the character can be standing away from the Interactable in order to interact")]
        [SerializeField] private float m_MaxHorizontalOffset = 0.5f;
        [Tooltip("The layer of objects that can perform the interaction")]
        [SerializeField] private LayerMask m_InteractorLayer;
        [Tooltip("The offset that the interactor should move to when interacting. A value of -1 means no movement on that axis")]
        [SerializeField] private Vector3 m_TargetInteractorOffset = new Vector3(-1, -1, -1);
        ...
        public bool CanInteract()
        {
            ...
            backward.y = interactorForward.y = cameraForward.y = 0;
            return Mathf.Abs(relativePosition.x) < m_MaxHorizontalOffset && relativePosition.z > 0 &&
                    ...
                    Vector3.Angle(backward, cameraForward) < m_CameraLookInteractMaxAngle;
        }
