...
namespace Opsive.ThirdPersonController
{
    ...
    {
        // Internal variables
        private SharedMethod<int, Item> m_ItemWithID = null;
        ...
        {
            EventHandler.ExecuteEvent(m_ItemWithID.Invoke(itemID).gameObject, eventName);
        }
        ...
        {
            EventHandler.ExecuteEvent(m_ItemWithID.Invoke(itemID).gameObject, eventName, arg1, arg2);
        }
        ...
        {
            EventHandler.ExecuteEvent<Transform, Vector3, Vector3>(m_ItemWithID.Invoke(itemID).gameObject, eventName, arg1.transform, arg2, arg3);
        }
    }
}
#endif