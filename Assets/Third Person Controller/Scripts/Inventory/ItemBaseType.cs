...
{
    /// <summary>
    /// An Item is the base class of any object can be picked up by the character. The ItemBaseType binds an Item to an object type that the Inventory can use to update 
