...
namespace Opsive.ThirdPersonController.Abilities
{
    ...
    public class DamageVisualization : Ability
    {
        ...
        {
            EventHandler.RegisterEvent<float, Vector3, Vector3>(m_GameObject, "OnHealthDamageDetails", TookDamage);
        ...
        {
            EventHandler.UnregisterEvent<float, Vector3, Vector3>(m_GameObject, "OnHealthDamageDetails", TookDamage);
        ...
        public override string GetDestinationState(int layer)
        {
            ...
            if (m_DamageType == DamageType.None || layer != m_AnimatorMonitor.GetAdditiveLayerIndex()) {
                return string.Empty;
            }
        ...
        private void TookDamage(float amount, Vector3 position, Vector3 force)
        {
            ...
            if (relativePosition.y < m_CapsuleCollider.center.y) {
                return;
            }
