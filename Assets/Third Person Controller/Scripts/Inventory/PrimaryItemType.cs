...
namespace Opsive.ThirdPersonController
{
    ...
    public class PrimaryItemType : ItemBaseType
    {
        ...
        public class UseableConsumableItem
        {
            ...
            [SerializeField] private ConsumableItemType m_ItemType;
            [Tooltip("The number of consumable item units the primary item can hold. For example, if the primary item is a pistol then it may be able to hold up to 12 bullets. In this example " +
                     "the capacity is 12")]
            [SerializeField] private int m_Capacity = int.MaxValue;
        ...
        public class DualWieldItem
        {
            ...
            [SerializeField] private bool m_PrimaryName;
        ...
        [Tooltip("The consumable item that can be used by the primary item")]
        [SerializeField] private UseableConsumableItem m_ConsumableItem;
        [Tooltip("The items that can dual wield with the current item")]
        [SerializeField] private DualWieldItem[] m_DualWieldItems;
        ...
        /// <summary>
        /// Overridden from the ItemBaseType class, will return int.MaxValue to specify that there is not a limit to the number of primary items that can be held. In most cases
