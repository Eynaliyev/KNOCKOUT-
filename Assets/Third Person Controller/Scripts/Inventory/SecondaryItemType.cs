...
namespace Opsive.ThirdPersonController
{
    ...
    /// </summary>
    public class SecondaryItemType : ItemBaseType
    {
        ...
        /// <summary>
        /// Overridden from the ItemBaseType class, will return the maximum number of secondary items that the inventory can hold.
        /// </summary>
